...
choose.alphas<-function(nndists.distribution, landscape.limit){
  a.8min<-nndists.distribution[1]/8 
  #average dispersal distance 8x smaller than mean(min) nndist 
  a.4min<-nndists.distribution[1]/4 
  #average dispersal distance 4x smaller than mean(min) nndist
  a.2min<-nndists.distribution[2]/2 
  #average dispersal distance 2x smaller than mean(min) nndist
