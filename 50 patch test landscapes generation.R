...
setwd("C:/Users/abuga/Desktop/Metapop R Package/Functions") #access working directory that all my metapop functions are stored in
source("Create Landscape Function.r") #load create.landscape.function
source("Rep Create Landscape Function.r") #load rep.create.landscape.function
source("NNDist Distribution Summary Function.r") #load nndist.summary function
source("Choose Alphas Function meanmins.r") #load choose alphas function
...
landscapes.data<-rep.create.landscape(n.patches=n.patches, landscape.limit=landscape.limit, no.runs=no.runs, no.replicates=no.replicates, directory=directory)
#############################################################################################################
